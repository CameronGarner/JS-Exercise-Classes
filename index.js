...
let person2 = new Instructor({
  name : "Brad",
  age: 26 , 
  location:"san fransisco",
  specialty: "Instructing",
  favlang: "CSS",
  catchphrase: "I instruct students on CSS"
...
sprintchallenge(subject){return `${this.name} has begun sprint challenge on ${subject}` }
 ...
 let newkid = new Student({
   name: "jerry",
   age: 32,
   location: "New York",
   previousbackground: "comedian",
   classname: "WEB3000",
   favsubjects: ["comedy","coding"]
 })

 console.log(newkid)

 console.log(newkid.listsubjects())

 console.log(newkid.PRAssignment("JAVA"))

 console.log(newkid.sprintchallenge("CSS"))
...
let PM1 = new ProjectManager({
  ...
  favlang: "Python",
  catchphrase: "standy times!",
  gradclassname: "WEB3000",
  favInstructor: "Brit"
})

console.log(PM1.standup("slack"))

console.log(PM1.debugscode(newkid,"JavaScript"))
